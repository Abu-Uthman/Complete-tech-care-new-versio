          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/80">
              <li className="flex items-start gap-2">
                ...
                <a href="mailto:bookings@ctc.example.com" className="hover:text-secondary transition-colors">
                  bookings@ctc.example.com
                </a>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-5 h-5 text-secondary mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="tel:+61400000000" className="hover:text-secondary transition-colors">
                  1300 CTC NOW
                </a>
              </li>
              <li className="flex items-start gap-2">
